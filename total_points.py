# How to calculate a player's total points given all of their plays

# List of their top plays in order (real values will be to 2 decimal places)
example_player = [210, 200, 190, 180, 170, 160, 155, 140, 122, 120, 110, 109, 108, 107, 106, 103, 102, 102, 101, 100, 99]

weighted_points = []

# n is the placement, points is the current item in the list
for n, points in enumerate(example_player):
...
print(total_points) # 2196.18 (rounded)

# As opposed to

print(sum(example_player)) # 2794
